...
for agent in agent_types:
    agent_reward_files.append(glob.glob("./Plots/ez/" + agent + "*reward.txt"))
...
#plt.title("Average Reward for all Agents (\"Hardcore\" Scenario)")
plt.savefig("base_reward_plot_ez_sizetest_nt")
    #plt.clf()
